...
| A-305 | P2 | **Contenido perecedero** "Top 5 oportunidades Q4-2026" (desde los packs corregidos), publicado como artículo de blog **sin gate**, promocionado en blog y retargeting. Rediseñado el 07-sep: la versión gated (email a cambio de la lista) se descartó porque nombre, zona y motivo de cada proyecto ya son públicos en /proyectos.html (el gate no protegía nada), y meter los números reales detrás del gate habría competido con la promesa del formulario largo. El valor real es la curación temporal, no el listado. Mockup del rediseño en `https://claude.ai/code/artifact/4dbd5201-bc11-4982-bc8d-24a9ad04f70f`. Pendiente de implementar en la ventana del día 30 | CTR al CTA de cierre / generate_lead por page_referrer de este artículo (no descargas/mes, ya no aplica) | J |
...
| E-09 (=A-305) | Top 5 Q4, sin gate | La curación temporal (por qué mirar esto ahora) mueve más clics al CTA de cierre que un artículo genérico | Web/Meta | 0 | 30 días | n/a | CTR al CTA / generate_lead por referrer | Tiempo en página | CTR ≥ media del blog | CTR muy por debajo de la media | 5,8 |
...
Principal: **memorándum de muestra real** (SAAS Hills o NH corregido) visible sin gate como prueba de nivel + **"Top 5 oportunidades Q4-2026"** como artículo abierto, sin gate (A-305, rediseñado 07-sep: ver nota en la tabla de fase 2). La guía fiscal se mantiene tras la validación del asesor, ya enviada y validada (A-209 cerrado el 07-sep).
