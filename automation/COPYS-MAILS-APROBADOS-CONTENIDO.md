# Horizonte Emirates - Copys completos aprobados (asunto + cuerpo)
...
- `${wa}` WhatsApp
- `${cal}` Calendly
- `${CONFIG.REPLY_TO}` email respuesta
...
### A1
**Asunto:** `Su análisis de inversión en Dubai ya está en marcha, ${n}`
...
### A2
**Asunto:** `${n}, 3 activos seleccionados para su perfil inversor`
...
- Dubai Marina/Business Bay: 7-8% neto aprox
- RAK pre-Wynn: +20-30% plusvalía desde 300k€
...
### A3
**Asunto:** `Un dato clave para su perfil inversor, ${n}`
...
### A4
**Asunto:** `Antes de decidir, ¿ha valorado visitar Dubai, ${n}?`
...
Usted sólo se ocupa del vuelo y alojamiento.
...
### A5
**Asunto:** `${n}, ¿mantiene Dubai como prioridad de inversión?`
...
Si sigue interesado, responda este email o WhatsApp ${wa}. Estamos a su disposición para ayudarle a invertir en Emiratos.
...
### B2
**Asunto:** `${n}, ¿agendamos 20 minutos esta semana?`

**Cuerpo (texto):**
```text
Estimado/a ${n},

Activos listos para ${cap} · ${obj}. ¿20 minutos esta semana? Sin compromiso.
...
### B4
**Asunto:** `Lo que cambia cuando ves Dubai en persona, ${n}`
...
### B5
**Asunto:** `${n}, activos disponibles esta semana para su perfil`
...
### B6
**Asunto:** `${n}, ¿sigue valorando invertir en Dubai?`
...
### B7
**Asunto:** `${n}, un último mensaje antes de hacer una pausa`
...
### C1
**Asunto:** `Gracias por su consulta sobre inversión en Dubai, ${n}`
...
### C2
**Asunto:** `España vs Dubai: comparativa rápida para inversores`
...
### C3
**Asunto:** `El proceso real de compra en Dubai, paso a paso`
...
### C5
**Asunto:** `La oportunidad en Ras Al Khaimah que tiene fecha de caducidad`
...
### C6
**Asunto:** `${n}, 20 minutos para decidir con datos si Dubai encaja`
...
### C8
**Asunto:** `${n}, ¿sigue en su radar invertir en Dubai?`
...
## Nota
- Este documento es de revision editorial.
- Si te encaja, en el siguiente paso aplico este contenido directamente en `automation/horizonte-emails.gs` (subject + text + html).
